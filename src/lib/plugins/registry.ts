...
export const PLUGINS: PluginDef[] = [
  ...
  },
  {
    ...
    category: "shipping",
    description: "Push orders to Shiprocket for courier booking and get tracking links back on the order.",
    ...
    fields: [
      ...
      { key: "pickupLocation", label: "Pickup location name", type: "text", placeholder: "Primary" },
    ],
    setupSteps: ["Shiprocket → Settings → API → Configure → create an API user.", "Add a pickup address in Settings → Pickup Addresses.", "Paste credentials and test. Use 'Ship via Shiprocket' on any order."],
  },
];
