    ...
    <div className="space-y-8">
      <section className="relative overflow-hidden rounded-[28px] bg-[#11110f] px-6 py-8 text-white sm:px-9 sm:py-10">
        ...
        <div className="relative flex flex-col justify-between gap-8 lg:flex-row lg:items-end">
          ...
          <div className="flex flex-wrap gap-2">
            <Link href="/admin" className="inline-flex shrink-0 items-center justify-center gap-2 rounded-xl bg-[#e9c78d] px-5 py-3 text-sm font-bold text-[#11110f] transition hover:bg-[#f2d8a7]"><LayoutDashboard className="h-4 w-4" /> Open admin</Link>
      ...
      <section className="grid gap-4 lg:grid-cols-[1fr_360px]">
        <div className="rounded-[24px] border border-black/10 bg-white p-6 sm:p-7">
          <div className="flex items-start justify-between gap-4"><div><div className="text-[11px] font-bold uppercase tracking-[0.2em] text-black/40">Store readiness</div><h2 className="mt-1 font-display text-2xl font-bold">Keep moving at your pace.</h2></div><Link href="/admin/settings" className="inline-flex items-center gap-2 rounded-xl border border-black/10 px-3 py-2 text-xs font-bold transition hover:border-black/30"><Settings2 className="h-4 w-4" /> Settings</Link></div>
