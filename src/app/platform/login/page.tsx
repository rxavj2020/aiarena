    ...
    <div className="min-h-screen bg-[#11110f] px-4 py-8 text-white sm:flex sm:items-center sm:justify-center">
      <div className="grid w-full max-w-[960px] overflow-hidden rounded-[28px] border border-white/10 bg-[#191916] shadow-2xl sm:grid-cols-2">
        ...
        <div className="p-7 sm:p-10">
          ...
          <div className="mb-7"><div className="mb-3 flex h-10 w-10 items-center justify-center rounded-2xl bg-white/10 text-[#e9c78d]"><LockKeyhole className="h-5 w-5" /></div><h1 className="font-display text-2xl font-bold">Welcome back</h1><p className="mt-1 text-sm text-white/50">Sign in to open your store control panel.</p></div>
