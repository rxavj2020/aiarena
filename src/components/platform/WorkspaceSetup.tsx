...
export function WorkspaceSetup({ tenant: initialTenant, setup: initialSetup }: { tenant: Tenant; setup: Setup }) {
  ...
  const [firestore, setFirestore] = useState<FirestoreInput>({ projectId: "", databaseId: "(default)", clientEmail: "", privateKey: "", collectionPrefix: "store_" });
