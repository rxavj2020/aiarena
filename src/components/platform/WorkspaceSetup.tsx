  ...
  return (
    <div className="space-y-7">
      <div className="flex flex-col justify-between gap-5 sm:flex-row sm:items-start">
        ...
        <div className="flex flex-wrap gap-2"><Link href={`/store/${tenant.slug}`} target="_blank" className="inline-flex items-center gap-2 rounded-xl border border-black/10 bg-white px-4 py-2.5 text-sm font-bold transition hover:border-black/30"><ExternalLink className="h-4 w-4" /> Preview site</Link><Link href="/dashboard" className="inline-flex items-center gap-2 rounded-xl bg-[#11110f] px-4 py-2.5 text-sm font-bold text-white transition hover:bg-black"><Store className="h-4 w-4" /> Open admin</Link></div>
      </div>
