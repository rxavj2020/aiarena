...
export function ProductCard({
  ...
  return (
    <div className="group card overflow-hidden hover:shadow-md transition-shadow relative flex flex-col justify-between">
      <div>
        <div className="relative aspect-square bg-gray-100 overflow-hidden">
          ...
          {off > 0 && (
            <span className="absolute left-3 top-3 badge bg-accent text-white">
              -{off}%
            </span>
          )}

          {out && (
            <span className="absolute left-3 bottom-3 badge bg-gray-900 text-white">
              Sold out
            </span>
          )}

          {/* Quick 1-click Wishlist Icon */}
